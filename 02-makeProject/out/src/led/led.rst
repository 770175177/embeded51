      ...
      000000                        264 	.ds 8
                                    ...
                                    326 	.area CSEG    (CODE)
                                    327 ;------------------------------------------------------------
                                    328 ;Allocation info for local variables in function 'led0'
                                    329 ;------------------------------------------------------------
                                    330 ;	src/led.c:5: int led0()
                                    331 ;	-----------------------------------------
                                    332 ;	 function led0
                                    333 ;	-----------------------------------------
      000062                        334 _led0:
                           ...
                           000001   341 	ar1 = 0x01
                           000000   342 	ar0 = 0x00
                                    343 ;	src/led.c:8: return 0;
      000062 90 00 00         [24]  344 	mov	dptr,#0x0000
                                    345 ;	src/led.c:9: }
      000065 22               [24]  346 	ret
                                    347 	.area CSEG    (CODE)
                                    348 	.area CONST   (CODE)
                                    349 	.area XINIT   (CODE)
