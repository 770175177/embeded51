      ...
      000000                        264 	.ds 8
                                    ...
                                    326 	.area CSEG    (CODE)
                                    327 ;------------------------------------------------------------
                                    328 ;Allocation info for local variables in function 'init_timer0'
                                    329 ;------------------------------------------------------------
                                    330 ;	src/timer.c:4: void init_timer0(void)
                                    331 ;	-----------------------------------------
                                    332 ;	 function init_timer0
                                    333 ;	-----------------------------------------
      00073A                        334 _init_timer0:
                           000007   335 	ar7 = 0x07
                           000006   336 	ar6 = 0x06
                           000005   337 	ar5 = 0x05
                           000004   338 	ar4 = 0x04
                           ...
                           000001   341 	ar1 = 0x01
                           000000   342 	ar0 = 0x00
                                    343 ;	src/timer.c:6: TH0 = (65536 - TIMER0_RELOAD_NUM) / 256;
      00073A 75 8C DC         [24]  344 	mov	_TH0,#0xdc
                                    345 ;	src/timer.c:7: TL0 = (65536 - TIMER0_RELOAD_NUM) % 256;
      00073D 75 8A 00         [24]  346 	mov	_TL0,#0x00
                                    347 ;	src/timer.c:8: TMOD &= 0xF0;
      000740 53 89 F0         [24]  348 	anl	_TMOD,#0xf0
                                    349 ;	src/timer.c:9: TMOD |= 0x01;
      000743 43 89 01         [24]  350 	orl	_TMOD,#0x01
                                    351 ;	src/timer.c:10: EA = 1;
                                    352 ;	assignBit
      000746 D2 AF            [12]  353 	setb	_EA
                                    354 ;	src/timer.c:11: ET0 = 1;
                                    355 ;	assignBit
      000748 D2 A9            [12]  356 	setb	_ET0
                                    357 ;	src/timer.c:12: TF0 = 0;
                                    358 ;	assignBit
      00074A C2 8D            [12]  359 	clr	_TF0
                                    360 ;	src/timer.c:13: TR0 = 1;
                                    361 ;	assignBit
      00074C D2 8C            [12]  362 	setb	_TR0
                                    363 ;	src/timer.c:14: }
      00074E 22               [24]  364 	ret
                                    365 	.area CSEG    (CODE)
                                    366 	.area CONST   (CODE)
                                    367 	.area XINIT   (CODE)
