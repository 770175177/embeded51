      ...
      000000                        264 	.ds 8
                                    ...
                                    326 	.area CSEG    (CODE)
                                    327 ;------------------------------------------------------------
                                    328 ;Allocation info for local variables in function 'uart'
                                    329 ;------------------------------------------------------------
                                    330 ;	src/uart.c:3: int uart()
                                    331 ;	-----------------------------------------
                                    332 ;	 function uart
                                    333 ;	-----------------------------------------
      000245                        334 _uart:
                           ...
                           000001   341 	ar1 = 0x01
                           000000   342 	ar0 = 0x00
                                    343 ;	src/uart.c:6: return 0;
      000245 90 00 00         [24]  344 	mov	dptr,#0x0000
                                    345 ;	src/uart.c:7: }
      000248 22               [24]  346 	ret
                                    347 	.area CSEG    (CODE)
                                    348 	.area CONST   (CODE)
                                    349 	.area XINIT   (CODE)
