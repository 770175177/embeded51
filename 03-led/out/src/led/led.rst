      ...
      000009                        275 _led_light_on_PARM_2:
      000009                        276 	.ds 1
      ...
      00012E                        343 _led_light_on:
                           ...
                           000001   350 	ar1 = 0x01
                           000000   351 	ar0 = 0x00
      00012E AF 82            [24]  352 	mov	r7,dpl
                                    353 ;	src/led.c:5: if (index >= LED_NUM)
      000130 BF 08 00         [24]  354 	cjne	r7,#0x08,00116$
      000133                        355 00116$:
      000133 40 04            [24]  356 	jc	00102$
                                    357 ;	src/led.c:6: return -1;
      000135 90 FF FF         [24]  358 	mov	dptr,#0xffff
      000138 22               [24]  359 	ret
      000139                        360 00102$:
                                    361 ;	src/led.c:8: if (on)
      000139 E5 09            [12]  362 	mov	a,_led_light_on_PARM_2
      00013B 60 15            [24]  363 	jz	00104$
                                    364 ;	src/led.c:9: LED &= ~(0x1 << index);
      00013D 8F 06            [24]  365 	mov	ar6,r7
      00013F 8E F0            [24]  366 	mov	b,r6
      000141 05 F0            [12]  367 	inc	b
      000143 74 01            [12]  368 	mov	a,#0x01
      000145 80 02            [24]  369 	sjmp	00121$
      000147                        370 00119$:
      000147 25 E0            [12]  371 	add	a,acc
      000149                        372 00121$:
      000149 D5 F0 FB         [24]  373 	djnz	b,00119$
      00014C F4               [12]  374 	cpl	a
      00014D FE               [12]  375 	mov	r6,a
      00014E 52 A0            [12]  376 	anl	_P2,a
      000150 80 10            [24]  377 	sjmp	00105$
      000152                        378 00104$:
                                    379 ;	src/led.c:11: LED |= (0x1 << index);
      000152 8F F0            [24]  380 	mov	b,r7
      000154 05 F0            [12]  381 	inc	b
      000156 74 01            [12]  382 	mov	a,#0x01
      000158 80 02            [24]  383 	sjmp	00124$
      00015A                        384 00122$:
      00015A 25 E0            [12]  385 	add	a,acc
      00015C                        386 00124$:
      00015C D5 F0 FB         [24]  387 	djnz	b,00122$
      00015F FF               [12]  388 	mov	r7,a
      000160 42 A0            [12]  389 	orl	_P2,a
      000162                        390 00105$:
                                    391 ;	src/led.c:13: return 0;
      000162 90 00 00         [24]  392 	mov	dptr,#0x0000
                                    393 ;	src/led.c:14: }
      000165 22               [24]  394 	ret
                                    395 ;------------------------------------------------------------
                                    ...
                                    404 ;	-----------------------------------------
      000166                        405 _led_light_is_on:
      000166 AF 82            [24]  406 	mov	r7,dpl
                                    407 ;	src/led.c:20: if (index >= LED_NUM)
      000168 BF 08 00         [24]  408 	cjne	r7,#0x08,00116$
      00016B                        409 00116$:
      00016B 40 04            [24]  410 	jc	00102$
                                    411 ;	src/led.c:21: return false;
      00016D 75 82 00         [24]  412 	mov	dpl,#0x00
      000170 22               [24]  413 	ret
      000171                        414 00102$:
                                    415 ;	src/led.c:23: value = LED;
      000171 E5 A0            [12]  416 	mov	a,_P2
                                    417 ;	src/led.c:25: if ((value >> index) & 0x1)
      000173 8F F0            [24]  418 	mov	b,r7
      000175 05 F0            [12]  419 	inc	b
      000177 80 02            [24]  420 	sjmp	00119$
      000179                        421 00118$:
      000179 C3               [12]  422 	clr	c
      00017A 13               [12]  423 	rrc	a
      00017B                        424 00119$:
      00017B D5 F0 FB         [24]  425 	djnz	b,00118$
      00017E 30 E0 04         [24]  426 	jnb	acc.0,00104$
                                    427 ;	src/led.c:26: return false;
      000181 75 82 00         [24]  428 	mov	dpl,#0x00
      000184 22               [24]  429 	ret
      000185                        430 00104$:
                                    431 ;	src/led.c:28: return true;
      000185 75 82 01         [24]  432 	mov	dpl,#0x01
                                    433 ;	src/led.c:29: }
      000188 22               [24]  434 	ret
                                    435 	.area CSEG    (CODE)
                                    436 	.area CONST   (CODE)
                                    437 	.area XINIT   (CODE)
