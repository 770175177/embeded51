      ...
      000009                        306 	.ds 4
      00000D                        307 _timer0_ISR_i_65536_52:
      00000D                        308 	.ds 2
                                    309 ;--------------------------------------------------------
      ...
      000003 02 03 47         [24]  364 	ljmp	_ext0_ISR
      000006                        365 	.ds	5
      00000B 02 03 E2         [24]  366 	ljmp	_timer0_ISR
      00000E                        367 	.ds	5
      000013 32               [24]  368 	reti
      000014                        369 	.ds	7
      00001B 32               [24]  370 	reti
      00001C                        371 	.ds	7
      000023 02 04 77         [24]  372 	ljmp	_uart_ISR
                                    373 ;--------------------------------------------------------
      ...
      000086 F5 0D            [12]  393 	mov	_timer0_ISR_i_65536_52,a
      000088 F5 0E            [12]  394 	mov	(_timer0_ISR_i_65536_52 + 1),a
      ...
      00020F 12 07 4B         [24]  450 	lcall	_print_short_hex
                                    451 ;	src/main.c:27: Prints("\n");
      000212 90 0F A9         [24]  452 	mov	dptr,#___str_1
      000215 75 F0 80         [24]  453 	mov	b,#0x80
      000218 12 07 20         [24]  454 	lcall	_Prints
                                    455 ;	src/main.c:29: usb_disconnect();
      00021B 12 08 C9         [24]  456 	lcall	_usb_disconnect
                                    457 ;	src/main.c:30: usb_connect();
      00021E 12 08 EA         [24]  458 	lcall	_usb_connect
      ...
      00022A 12 04 80         [24]  467 	lcall	_D12_write_command
                                    468 ;	src/main.c:39: status = D12_read_byte();
      00022D 12 04 8E         [24]  469 	lcall	_D12_read_byte
      ...
      000238 12 09 05         [24]  476 	lcall	_usb_bus_isr_suspend
      ...
      000243 12 09 0E         [24]  484 	lcall	_usb_bus_isr_reset
      ...
      00024E 12 09 1B         [24]  492 	lcall	_usb_bus_isr_ep0_out
      ...
      000259 12 0D 96         [24]  500 	lcall	_usb_bus_isr_ep0_in
      ...
      000264 12 0D A8         [24]  508 	lcall	_usb_bus_isr_ep1_out
      ...
      00026F 12 0D B1         [24]  516 	lcall	_usb_bus_isr_ep1_in
      ...
      00027A 12 0D C4         [24]  524 	lcall	_usb_bus_isr_ep2_out
      ...
      000283 12 0D CD         [24]  531 	lcall	_usb_bus_isr_ep2_in
      000286                        532 00118$:
                                    533 ;	src/main.c:58: if (ConfigValue != 0) {
      000286 E5 44            [12]  534 	mov	a,_ConfigValue
      000288 60 9A            [24]  535 	jz	00128$
                                    536 ;	src/main.c:59: LED = ~KeyPress;
      00028A 78 58            [12]  537 	mov	r0,#_KeyPress
      00028C E6               [12]  538 	mov	a,@r0
      00028D F4               [12]  539 	cpl	a
      00028E F5 A0            [12]  540 	mov	_P2,a
                                    541 ;	src/main.c:60: if (!Ep1InIsBusy) {
      000290 E5 43            [12]  542 	mov	a,_Ep1InIsBusy
                                    543 ;	src/main.c:61: KeyCanChange = 0;
      000292 70 90            [24]  544 	jnz	00128$
      000294 78 5C            [12]  545 	mov	r0,#_KeyCanChange
      000296 F6               [12]  546 	mov	@r0,a
                                    547 ;	src/main.c:62: if (KeyUp || KeyDown || KeyPress)
      000297 78 5A            [12]  548 	mov	r0,#_KeyUp
      000299 E6               [12]  549 	mov	a,@r0
      00029A 70 0A            [24]  550 	jnz	00119$
      00029C 78 59            [12]  551 	mov	r0,#_KeyDown
      00029E E6               [12]  552 	mov	a,@r0
      00029F 70 05            [24]  553 	jnz	00119$
      0002A1 78 58            [12]  554 	mov	r0,#_KeyPress
      0002A3 E6               [12]  555 	mov	a,@r0
      0002A4 60 03            [24]  556 	jz	00120$
      0002A6                        557 00119$:
                                    558 ;	src/main.c:63: SendReport();
      0002A6 12 02 B0         [24]  559 	lcall	_SendReport
      0002A9                        560 00120$:
                                    561 ;	src/main.c:64: KeyCanChange = 1;
      0002A9 78 5C            [12]  562 	mov	r0,#_KeyCanChange
      0002AB 76 01            [12]  563 	mov	@r0,#0x01
                                    564 ;	src/main.c:68: }
      0002AD 02 02 24         [24]  565 	ljmp	00128$
                                    566 ;------------------------------------------------------------
                                    ...
                                    574 ;	-----------------------------------------
      0002B0                        575 _SendReport:
                                    576 ;	src/main.c:75: int8 Buf[4]={0,0,0,0};
      0002B0 75 09 00         [24]  577 	mov	_SendReport_Buf_65536_39,#0x00
      0002B3 75 0A 00         [24]  578 	mov	(_SendReport_Buf_65536_39 + 0x0001),#0x00
      0002B6 75 0B 00         [24]  579 	mov	(_SendReport_Buf_65536_39 + 0x0002),#0x00
      0002B9 75 0C 00         [24]  580 	mov	(_SendReport_Buf_65536_39 + 0x0003),#0x00
                                    581 ;	src/main.c:78: KeyUp &=~(KEY1|KEY2|KEY3|KEY4|KEY5|KEY6);
      0002BC 78 5A            [12]  582 	mov	r0,#_KeyUp
      0002BE E6               [12]  583 	mov	a,@r0
      0002BF 54 C0            [12]  584 	anl	a,#0xc0
      0002C1 F6               [12]  585 	mov	@r0,a
                                    586 ;	src/main.c:79: KeyDown &=~(KEY1|KEY2|KEY3|KEY4|KEY5|KEY6);
      0002C2 78 59            [12]  587 	mov	r0,#_KeyDown
      0002C4 E6               [12]  588 	mov	a,@r0
      0002C5 54 C0            [12]  589 	anl	a,#0xc0
      0002C7 F6               [12]  590 	mov	@r0,a
                                    591 ;	src/main.c:83: if((KeyPress&(~(KEY7|KEY8)))||KeyUp||KeyDown)
      0002C8 78 58            [12]  592 	mov	r0,#_KeyPress
      0002CA E6               [12]  593 	mov	a,@r0
      0002CB 54 3F            [12]  594 	anl	a,#0x3f
      0002CD 60 02            [24]  595 	jz	00164$
      0002CF 80 0A            [24]  596 	sjmp	00117$
      0002D1                        597 00164$:
      0002D1 78 5A            [12]  598 	mov	r0,#_KeyUp
      0002D3 E6               [12]  599 	mov	a,@r0
      0002D4 70 05            [24]  600 	jnz	00117$
      0002D6 78 59            [12]  601 	mov	r0,#_KeyDown
      0002D8 E6               [12]  602 	mov	a,@r0
      0002D9 60 63            [24]  603 	jz	00118$
      0002DB                        604 00117$:
                                    605 ;	src/main.c:85: if(KeyPress & KEY1) //??KEY1????????????X?????
      0002DB 78 58            [12]  606 	mov	r0,#_KeyPress
      0002DD E6               [12]  607 	mov	a,@r0
      0002DE 30 E0 03         [24]  608 	jnb	acc.0,00102$
                                    609 ;	src/main.c:87: Buf[1]=-1;  //?????????????
      0002E1 75 0A FF         [24]  610 	mov	(_SendReport_Buf_65536_39 + 0x0001),#0xff
      0002E4                        611 00102$:
                                    612 ;	src/main.c:89: if(KeyPress & KEY2) //??KEY2????????????X?????
      0002E4 78 58            [12]  613 	mov	r0,#_KeyPress
      0002E6 E6               [12]  614 	mov	a,@r0
      0002E7 30 E1 03         [24]  615 	jnb	acc.1,00104$
                                    616 ;	src/main.c:91: Buf[1]=1;   //?????????????
      0002EA 75 0A 01         [24]  617 	mov	(_SendReport_Buf_65536_39 + 0x0001),#0x01
      0002ED                        618 00104$:
                                    619 ;	src/main.c:93: if(KeyPress & KEY3) //??KEY3????????????Y?????
      0002ED 78 58            [12]  620 	mov	r0,#_KeyPress
      0002EF E6               [12]  621 	mov	a,@r0
      0002F0 30 E2 03         [24]  622 	jnb	acc.2,00106$
                                    623 ;	src/main.c:95: Buf[2]=-1;   //?????????????
      0002F3 75 0B FF         [24]  624 	mov	(_SendReport_Buf_65536_39 + 0x0002),#0xff
      0002F6                        625 00106$:
                                    626 ;	src/main.c:97: if(KeyPress & KEY4)  //??KEY4????????????Y?????
      0002F6 78 58            [12]  627 	mov	r0,#_KeyPress
      0002F8 E6               [12]  628 	mov	a,@r0
      0002F9 30 E3 03         [24]  629 	jnb	acc.3,00108$
                                    630 ;	src/main.c:99: Buf[2]=1;  //?????????????
      0002FC 75 0B 01         [24]  631 	mov	(_SendReport_Buf_65536_39 + 0x0002),#0x01
      0002FF                        632 00108$:
                                    633 ;	src/main.c:101: if(KeyPress & KEY5)  //??KEY5????????????????
      0002FF 78 58            [12]  634 	mov	r0,#_KeyPress
      000301 E6               [12]  635 	mov	a,@r0
      000302 30 E4 03         [24]  636 	jnb	acc.4,00110$
                                    637 ;	src/main.c:103: Buf[3]=-1;  //?????????????
      000305 75 0C FF         [24]  638 	mov	(_SendReport_Buf_65536_39 + 0x0003),#0xff
      000308                        639 00110$:
                                    640 ;	src/main.c:105: if(KeyPress & KEY6)  //??KEY6???????????????
      000308 78 58            [12]  641 	mov	r0,#_KeyPress
      00030A E6               [12]  642 	mov	a,@r0
      00030B 30 E5 03         [24]  643 	jnb	acc.5,00112$
                                    644 ;	src/main.c:107: Buf[3]=1;   //?????????????
      00030E 75 0C 01         [24]  645 	mov	(_SendReport_Buf_65536_39 + 0x0003),#0x01
      000311                        646 00112$:
                                    647 ;	src/main.c:109: if(KeyPress & KEY7)  //????
      000311 78 58            [12]  648 	mov	r0,#_KeyPress
      000313 E6               [12]  649 	mov	a,@r0
      000314 30 E6 06         [24]  650 	jnb	acc.6,00114$
                                    651 ;	src/main.c:111: Buf[0]|=0x01;  //D0?????
      000317 74 01            [12]  652 	mov	a,#0x01
      000319 45 09            [12]  653 	orl	a,_SendReport_Buf_65536_39
      00031B F5 09            [12]  654 	mov	_SendReport_Buf_65536_39,a
      00031D                        655 00114$:
                                    656 ;	src/main.c:113: if(KeyPress & KEY8)  //????
      00031D 78 58            [12]  657 	mov	r0,#_KeyPress
      00031F E6               [12]  658 	mov	a,@r0
      000320 30 E7 06         [24]  659 	jnb	acc.7,00116$
                                    660 ;	src/main.c:115: Buf[0]|=0x02;  //D1?????
      000323 74 02            [12]  661 	mov	a,#0x02
      000325 45 09            [12]  662 	orl	a,_SendReport_Buf_65536_39
      000327 F5 09            [12]  663 	mov	_SendReport_Buf_65536_39,a
      000329                        664 00116$:
                                    665 ;	src/main.c:118: D12_write_endpoint_buffer(3, 4, Buf);
      000329 75 14 09         [24]  666 	mov	_D12_write_endpoint_buffer_PARM_3,#_SendReport_Buf_65536_39
      00032C 75 15 00         [24]  667 	mov	(_D12_write_endpoint_buffer_PARM_3 + 1),#0x00
      00032F 75 16 40         [24]  668 	mov	(_D12_write_endpoint_buffer_PARM_3 + 2),#0x40
      000332 75 13 04         [24]  669 	mov	_D12_write_endpoint_buffer_PARM_2,#0x04
      000335 75 82 03         [24]  670 	mov	dpl,#0x03
      000338 12 05 E8         [24]  671 	lcall	_D12_write_endpoint_buffer
                                    672 ;	src/main.c:119: Ep1InIsBusy=1;  //????????
      00033B 75 43 01         [24]  673 	mov	_Ep1InIsBusy,#0x01
      00033E                        674 00118$:
                                    675 ;	src/main.c:122: KeyUp=0;
      00033E 78 5A            [12]  676 	mov	r0,#_KeyUp
      000340 76 00            [12]  677 	mov	@r0,#0x00
                                    678 ;	src/main.c:123: KeyDown=0;
      000342 78 59            [12]  679 	mov	r0,#_KeyDown
      000344 76 00            [12]  680 	mov	@r0,#0x00
                                    681 ;	src/main.c:124: }
      000346 22               [24]  682 	ret
                                    683 ;------------------------------------------------------------
                                    ...
                                    691 ;	-----------------------------------------
      000347                        692 _ext0_ISR:
      000347 C0 20            [24]  693 	push	bits
      000349 C0 E0            [24]  694 	push	acc
      00034B C0 F0            [24]  695 	push	b
      00034D C0 82            [24]  696 	push	dpl
      00034F C0 83            [24]  697 	push	dph
      000351 C0 07            [24]  698 	push	(0+7)
      000353 C0 06            [24]  699 	push	(0+6)
      000355 C0 05            [24]  700 	push	(0+5)
      000357 C0 04            [24]  701 	push	(0+4)
      000359 C0 03            [24]  702 	push	(0+3)
      00035B C0 02            [24]  703 	push	(0+2)
      00035D C0 01            [24]  704 	push	(0+1)
      00035F C0 00            [24]  705 	push	(0+0)
      000361 C0 D0            [24]  706 	push	psw
      000363 75 D0 00         [24]  707 	mov	psw,#0x00
                                    708 ;	src/main.c:130: D12_write_command(D12_READ_INTERRUPT_REG);
      000366 75 82 F4         [24]  709 	mov	dpl,#0xf4
      000369 12 04 80         [24]  710 	lcall	_D12_write_command
                                    711 ;	src/main.c:131: status = D12_read_byte();
      00036C 12 04 8E         [24]  712 	lcall	_D12_read_byte
                                    713 ;	src/main.c:132: if(status & 0x80)
      00036F E5 82            [12]  714 	mov	a,dpl
      000371 FF               [12]  715 	mov	r7,a
      000372 30 E7 07         [24]  716 	jnb	acc.7,00102$
                                    717 ;	src/main.c:133: usb_bus_isr_suspend();
      000375 C0 07            [24]  718 	push	ar7
      000377 12 09 05         [24]  719 	lcall	_usb_bus_isr_suspend
      00037A D0 07            [24]  720 	pop	ar7
      00037C                        721 00102$:
                                    722 ;	src/main.c:134: if(status & 0x40)
      00037C EF               [12]  723 	mov	a,r7
      00037D 30 E6 07         [24]  724 	jnb	acc.6,00104$
                                    725 ;	src/main.c:135: usb_bus_isr_reset();
      000380 C0 07            [24]  726 	push	ar7
      000382 12 09 0E         [24]  727 	lcall	_usb_bus_isr_reset
      000385 D0 07            [24]  728 	pop	ar7
      000387                        729 00104$:
                                    730 ;	src/main.c:136: if(status & 0x01)
      000387 EF               [12]  731 	mov	a,r7
      000388 30 E0 07         [24]  732 	jnb	acc.0,00106$
                                    733 ;	src/main.c:137: usb_bus_isr_ep0_out();
      00038B C0 07            [24]  734 	push	ar7
      00038D 12 09 1B         [24]  735 	lcall	_usb_bus_isr_ep0_out
      000390 D0 07            [24]  736 	pop	ar7
      000392                        737 00106$:
                                    738 ;	src/main.c:138: if(status & 0x02)
      000392 EF               [12]  739 	mov	a,r7
      000393 30 E1 07         [24]  740 	jnb	acc.1,00108$
                                    741 ;	src/main.c:139: usb_bus_isr_ep0_in();
      000396 C0 07            [24]  742 	push	ar7
      000398 12 0D 96         [24]  743 	lcall	_usb_bus_isr_ep0_in
      00039B D0 07            [24]  744 	pop	ar7
      00039D                        745 00108$:
                                    746 ;	src/main.c:140: if(status & 0x04)
      00039D EF               [12]  747 	mov	a,r7
      00039E 30 E2 07         [24]  748 	jnb	acc.2,00110$
                                    749 ;	src/main.c:141: usb_bus_isr_ep1_out();
      0003A1 C0 07            [24]  750 	push	ar7
      0003A3 12 0D A8         [24]  751 	lcall	_usb_bus_isr_ep1_out
      0003A6 D0 07            [24]  752 	pop	ar7
      0003A8                        753 00110$:
                                    754 ;	src/main.c:142: if(status & 0x08)
      0003A8 EF               [12]  755 	mov	a,r7
      0003A9 30 E3 07         [24]  756 	jnb	acc.3,00112$
                                    757 ;	src/main.c:143: usb_bus_isr_ep1_in();
      0003AC C0 07            [24]  758 	push	ar7
      0003AE 12 0D B1         [24]  759 	lcall	_usb_bus_isr_ep1_in
      0003B1 D0 07            [24]  760 	pop	ar7
      0003B3                        761 00112$:
                                    762 ;	src/main.c:144: if(status & 0x10)
      0003B3 EF               [12]  763 	mov	a,r7
      0003B4 30 E4 07         [24]  764 	jnb	acc.4,00114$
                                    765 ;	src/main.c:145: usb_bus_isr_ep2_out();
      0003B7 C0 07            [24]  766 	push	ar7
      0003B9 12 0D C4         [24]  767 	lcall	_usb_bus_isr_ep2_out
      0003BC D0 07            [24]  768 	pop	ar7
      0003BE                        769 00114$:
                                    770 ;	src/main.c:146: if(status & 0x20)
      0003BE EF               [12]  771 	mov	a,r7
      0003BF 30 E5 03         [24]  772 	jnb	acc.5,00117$
                                    773 ;	src/main.c:147: usb_bus_isr_ep2_in();
      0003C2 12 0D CD         [24]  774 	lcall	_usb_bus_isr_ep2_in
      0003C5                        775 00117$:
                                    776 ;	src/main.c:148: }
      0003C5 D0 D0            [24]  777 	pop	psw
      0003C7 D0 00            [24]  778 	pop	(0+0)
      0003C9 D0 01            [24]  779 	pop	(0+1)
      0003CB D0 02            [24]  780 	pop	(0+2)
      0003CD D0 03            [24]  781 	pop	(0+3)
      0003CF D0 04            [24]  782 	pop	(0+4)
      0003D1 D0 05            [24]  783 	pop	(0+5)
      0003D3 D0 06            [24]  784 	pop	(0+6)
      0003D5 D0 07            [24]  785 	pop	(0+7)
      0003D7 D0 83            [24]  786 	pop	dph
      0003D9 D0 82            [24]  787 	pop	dpl
      0003DB D0 F0            [24]  788 	pop	b
      0003DD D0 E0            [24]  789 	pop	acc
      0003DF D0 20            [24]  790 	pop	bits
      0003E1 32               [24]  791 	reti
                                    792 ;------------------------------------------------------------
                                    ...
                                    800 ;	-----------------------------------------
      0003E2                        801 _timer0_ISR:
      0003E2 C0 E0            [24]  802 	push	acc
      0003E4 C0 F0            [24]  803 	push	b
      0003E6 C0 07            [24]  804 	push	ar7
      0003E8 C0 01            [24]  805 	push	ar1
      0003EA C0 00            [24]  806 	push	ar0
      0003EC C0 D0            [24]  807 	push	psw
      0003EE 75 D0 00         [24]  808 	mov	psw,#0x00
                                    809 ;	src/main.c:154: TH0 = (65536 - TIMER0_RELOAD_NUM) / 256;
      0003F1 75 8C DC         [24]  810 	mov	_TH0,#0xdc
                                    811 ;	src/main.c:155: TL0 = (65536 - TIMER0_RELOAD_NUM) % 256;
      0003F4 75 8A 00         [24]  812 	mov	_TL0,#0x00
                                    813 ;	src/main.c:157: i++;
      0003F7 05 0D            [12]  814 	inc	_timer0_ISR_i_65536_52
      0003F9 E4               [12]  815 	clr	a
      0003FA B5 0D 02         [24]  816 	cjne	a,_timer0_ISR_i_65536_52,00128$
      0003FD 05 0E            [12]  817 	inc	(_timer0_ISR_i_65536_52 + 1)
      0003FF                        818 00128$:
                                    819 ;	src/main.c:158: if (i > 200) {
      0003FF C3               [12]  820 	clr	c
      000400 74 C8            [12]  821 	mov	a,#0xc8
      000402 95 0D            [12]  822 	subb	a,_timer0_ISR_i_65536_52
      000404 E4               [12]  823 	clr	a
      000405 95 0E            [12]  824 	subb	a,(_timer0_ISR_i_65536_52 + 1)
      000407 50 05            [24]  825 	jnc	00102$
                                    826 ;	src/main.c:159: i = 0;
      000409 E4               [12]  827 	clr	a
      00040A F5 0D            [12]  828 	mov	_timer0_ISR_i_65536_52,a
      00040C F5 0E            [12]  829 	mov	(_timer0_ISR_i_65536_52 + 1),a
      00040E                        830 00102$:
                                    831 ;	src/main.c:163: if (!KeyCanChange)
      00040E 78 5C            [12]  832 	mov	r0,#_KeyCanChange
      000410 E6               [12]  833 	mov	a,@r0
      000411 70 02            [24]  834 	jnz	00104$
                                    835 ;	src/main.c:164: return;
      000413 80 55            [24]  836 	sjmp	00110$
      000415                        837 00104$:
                                    838 ;	src/main.c:166: KeyCurrent = GetKeyValue();
      000415 E5 90            [12]  839 	mov	a,_P1
      000417 F4               [12]  840 	cpl	a
      000418 FF               [12]  841 	mov	r7,a
      000419 78 55            [12]  842 	mov	r0,#_KeyCurrent
      00041B A6 07            [24]  843 	mov	@r0,ar7
                                    844 ;	src/main.c:168: if (KeyCurrent != KeyOld) {
      00041D 78 55            [12]  845 	mov	r0,#_KeyCurrent
      00041F 79 56            [12]  846 	mov	r1,#_KeyOld
      000421 86 F0            [24]  847 	mov	b,@r0
      000423 E7               [12]  848 	mov	a,@r1
      000424 B5 F0 02         [24]  849 	cjne	a,b,00131$
      000427 80 0C            [24]  850 	sjmp	00108$
      000429                        851 00131$:
                                    852 ;	src/main.c:169: KeyNoChangedTime = 0;
      000429 78 57            [12]  853 	mov	r0,#_KeyNoChangedTime
      00042B 76 00            [12]  854 	mov	@r0,#0x00
                                    855 ;	src/main.c:170: KeyOld = KeyCurrent;
      00042D 78 55            [12]  856 	mov	r0,#_KeyCurrent
      00042F 79 56            [12]  857 	mov	r1,#_KeyOld
      000431 E6               [12]  858 	mov	a,@r0
      000432 F7               [12]  859 	mov	@r1,a
                                    860 ;	src/main.c:171: return;
      000433 80 35            [24]  861 	sjmp	00110$
      000435                        862 00108$:
                                    863 ;	src/main.c:174: KeyNoChangedTime++;
      000435 78 57            [12]  864 	mov	r0,#_KeyNoChangedTime
      000437 E6               [12]  865 	mov	a,@r0
      000438 78 57            [12]  866 	mov	r0,#_KeyNoChangedTime
      00043A 04               [12]  867 	inc	a
      00043B F6               [12]  868 	mov	@r0,a
                                    869 ;	src/main.c:175: if (KeyNoChangedTime >= 1) {
      00043C 78 57            [12]  870 	mov	r0,#_KeyNoChangedTime
      00043E B6 01 00         [24]  871 	cjne	@r0,#0x01,00132$
      000441                        872 00132$:
      000441 40 27            [24]  873 	jc	00110$
                                    874 ;	src/main.c:176: KeyNoChangedTime = 1;
      000443 78 57            [12]  875 	mov	r0,#_KeyNoChangedTime
      000445 76 01            [12]  876 	mov	@r0,#0x01
                                    877 ;	src/main.c:177: KeyPress = KeyOld;
      000447 78 56            [12]  878 	mov	r0,#_KeyOld
      000449 79 58            [12]  879 	mov	r1,#_KeyPress
      00044B E6               [12]  880 	mov	a,@r0
      00044C F7               [12]  881 	mov	@r1,a
                                    882 ;	src/main.c:178: KeyDown |= (~KeyLast) & (KeyPress);
      00044D 78 5B            [12]  883 	mov	r0,#_KeyLast
      00044F E6               [12]  884 	mov	a,@r0
      000450 F4               [12]  885 	cpl	a
      000451 FF               [12]  886 	mov	r7,a
      000452 78 58            [12]  887 	mov	r0,#_KeyPress
      000454 E6               [12]  888 	mov	a,@r0
      000455 5F               [12]  889 	anl	a,r7
      000456 78 59            [12]  890 	mov	r0,#_KeyDown
      000458 46               [12]  891 	orl	a,@r0
      000459 F6               [12]  892 	mov	@r0,a
                                    893 ;	src/main.c:179: KeyUp |= KeyLast & (KeyPress);
      00045A 78 5B            [12]  894 	mov	r0,#_KeyLast
      00045C 79 58            [12]  895 	mov	r1,#_KeyPress
      00045E E7               [12]  896 	mov	a,@r1
      00045F 56               [12]  897 	anl	a,@r0
      000460 78 5A            [12]  898 	mov	r0,#_KeyUp
      000462 46               [12]  899 	orl	a,@r0
      000463 F6               [12]  900 	mov	@r0,a
                                    901 ;	src/main.c:180: KeyLast = KeyPress;
      000464 78 58            [12]  902 	mov	r0,#_KeyPress
      000466 79 5B            [12]  903 	mov	r1,#_KeyLast
      000468 E6               [12]  904 	mov	a,@r0
      000469 F7               [12]  905 	mov	@r1,a
      00046A                        906 00110$:
                                    907 ;	src/main.c:183: }
      00046A D0 D0            [24]  908 	pop	psw
      00046C D0 00            [24]  909 	pop	ar0
      00046E D0 01            [24]  910 	pop	ar1
      000470 D0 07            [24]  911 	pop	ar7
      000472 D0 F0            [24]  912 	pop	b
      000474 D0 E0            [24]  913 	pop	acc
      000476 32               [24]  914 	reti
                                    ...
                                    923 ;	-----------------------------------------
      000477                        924 _uart_ISR:
                                    925 ;	src/main.c:187: if (RI) {
                                    926 ;	src/main.c:188: RI = 0;			/* clear recieve interrupt */
                                    927 ;	assignBit
      000477 10 98 05         [24]  928 	jbc	_RI,00104$
                                    929 ;	src/main.c:190: TI = 0;
                                    930 ;	assignBit
      00047A C2 99            [12]  931 	clr	_TI
                                    932 ;	src/main.c:191: sending = 0;
      00047C 75 21 00         [24]  933 	mov	_sending,#0x00
      00047F                        934 00104$:
                                    935 ;	src/main.c:193: }
      00047F 32               [24]  936 	reti
                                    ...
                                    945 	.area CONST   (CODE)
      000F93                        946 ___str_0:
      000F93 72 65 61 64 20 70 64   947 	.ascii "read pdiusb12 id is: "
             69 75 73 62 31 32 20
             69 64 20 69 73 3A 20
      000FA8 00                     948 	.db 0x00
                                    949 	.area CSEG    (CODE)
                                    950 	.area CONST   (CODE)
      000FA9                        951 ___str_1:
      000FA9 0A                     952 	.db 0x0a
      000FAA 00                     953 	.db 0x00
                                    954 	.area CSEG    (CODE)
                                    955 	.area XINIT   (CODE)
