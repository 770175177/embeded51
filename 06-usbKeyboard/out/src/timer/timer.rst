      ...
      0006DB 75 8C DC         [24]  344 	mov	_TH0,#0xdc
                                    345 ;	src/timer.c:7: TL0 = (65536 - TIMER0_RELOAD_NUM) % 256;
      0006DE 75 8A 00         [24]  346 	mov	_TL0,#0x00
                                    347 ;	src/timer.c:8: TMOD &= 0xF0;
      0006E1 53 89 F0         [24]  348 	anl	_TMOD,#0xf0
                                    349 ;	src/timer.c:9: TMOD |= 0x01;
      0006E4 43 89 01         [24]  350 	orl	_TMOD,#0x01
                                    351 ;	src/timer.c:10: EA = 1;
                                    352 ;	assignBit
      0006E7 D2 AF            [12]  353 	setb	_EA
                                    354 ;	src/timer.c:11: ET0 = 1;
                                    355 ;	assignBit
      0006E9 D2 A9            [12]  356 	setb	_ET0
                                    357 ;	src/timer.c:12: TF0 = 0;
                                    358 ;	assignBit
      0006EB C2 8D            [12]  359 	clr	_TF0
                                    360 ;	src/timer.c:13: TR0 = 1;
                                    361 ;	assignBit
      0006ED D2 8C            [12]  362 	setb	_TR0
                                    363 ;	src/timer.c:14: }
      0006EF 22               [24]  364 	ret
                                    365 	.area CSEG    (CODE)
                                    366 	.area CONST   (CODE)
                                    367 	.area XINIT   (CODE)
