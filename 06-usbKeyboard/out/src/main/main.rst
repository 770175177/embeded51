      ...
      000009                        306 	.ds 8
      000011                        307 _timer0_ISR_i_65536_51:
      000011                        308 	.ds 2
                                    309 ;--------------------------------------------------------
      ...
      000003 02 03 3F         [24]  364 	ljmp	_ext0_ISR
      000006                        365 	.ds	5
      00000B 02 03 DA         [24]  366 	ljmp	_timer0_ISR
      00000E                        367 	.ds	5
      000013 32               [24]  368 	reti
      000014                        369 	.ds	7
      00001B 32               [24]  370 	reti
      00001C                        371 	.ds	7
      000023 02 04 6F         [24]  372 	ljmp	_uart_ISR
                                    373 ;--------------------------------------------------------
      ...
      000086 F5 11            [12]  393 	mov	_timer0_ISR_i_65536_51,a
      000088 F5 12            [12]  394 	mov	(_timer0_ISR_i_65536_51 + 1),a
      ...
      00020F 12 07 43         [24]  450 	lcall	_print_short_hex
                                    451 ;	src/main.c:27: Prints("\n");
      000212 90 0F C2         [24]  452 	mov	dptr,#___str_1
      000215 75 F0 80         [24]  453 	mov	b,#0x80
      000218 12 07 18         [24]  454 	lcall	_Prints
                                    455 ;	src/main.c:29: usb_disconnect();
      00021B 12 08 C1         [24]  456 	lcall	_usb_disconnect
                                    457 ;	src/main.c:30: usb_connect();
      00021E 12 08 E2         [24]  458 	lcall	_usb_connect
      ...
      00022A 12 04 78         [24]  467 	lcall	_D12_write_command
                                    468 ;	src/main.c:39: status = D12_read_byte();
      00022D 12 04 86         [24]  469 	lcall	_D12_read_byte
      ...
      000238 12 08 FD         [24]  476 	lcall	_usb_bus_isr_suspend
      ...
      000243 12 09 06         [24]  484 	lcall	_usb_bus_isr_reset
      ...
      00024E 12 09 13         [24]  492 	lcall	_usb_bus_isr_ep0_out
      ...
      000259 12 0D 8E         [24]  500 	lcall	_usb_bus_isr_ep0_in
      ...
      000264 12 0D A0         [24]  508 	lcall	_usb_bus_isr_ep1_out
      ...
      00026F 12 0D CA         [24]  516 	lcall	_usb_bus_isr_ep1_in
      ...
      00027A 12 0D DD         [24]  524 	lcall	_usb_bus_isr_ep2_out
      ...
      000283 12 0D E6         [24]  531 	lcall	_usb_bus_isr_ep2_in
      000286                        532 00118$:
      ...
      00029E 78 5D            [12]  554 	mov	r0,#_KeyCanChange
      ...
      0002BD 7F 02            [12]  579 	mov	r7,#0x02
                                    580 ;	src/main.c:85: if(KeyPress & KEY1) //??KEY1??
      0002BF 78 59            [12]  581 	mov	r0,#_KeyPress
      0002C1 E6               [12]  582 	mov	a,@r0
      0002C2 30 E0 06         [24]  583 	jnb	acc.0,00102$
                                    584 ;	src/main.c:87: Buf[0]|=0x01;  //KEY1??Ctrl??
      0002C5 74 01            [12]  585 	mov	a,#0x01
      0002C7 45 09            [12]  586 	orl	a,_SendReport_Buf_65536_39
      0002C9 F5 09            [12]  587 	mov	_SendReport_Buf_65536_39,a
      0002CB                        588 00102$:
                                    589 ;	src/main.c:89: if(KeyPress & KEY2) //??KEY2??
      0002CB 78 59            [12]  590 	mov	r0,#_KeyPress
      0002CD E6               [12]  591 	mov	a,@r0
      0002CE 30 E1 06         [24]  592 	jnb	acc.1,00104$
                                    593 ;	src/main.c:91: Buf[0]|=0x02;  //KEY2??Shift??
      0002D1 74 02            [12]  594 	mov	a,#0x02
      0002D3 45 09            [12]  595 	orl	a,_SendReport_Buf_65536_39
      0002D5 F5 09            [12]  596 	mov	_SendReport_Buf_65536_39,a
      0002D7                        597 00104$:
                                    598 ;	src/main.c:93: if(KeyPress & KEY3) //??KEY3??
      0002D7 78 59            [12]  599 	mov	r0,#_KeyPress
      0002D9 E6               [12]  600 	mov	a,@r0
      0002DA 30 E2 06         [24]  601 	jnb	acc.2,00106$
                                    602 ;	src/main.c:95: Buf[0]|=0x04;  //KEY3??Alt?
      0002DD 74 04            [12]  603 	mov	a,#0x04
      0002DF 45 09            [12]  604 	orl	a,_SendReport_Buf_65536_39
      0002E1 F5 09            [12]  605 	mov	_SendReport_Buf_65536_39,a
      0002E3                        606 00106$:
                                    607 ;	src/main.c:97: if(KeyPress & KEY4) //??KEY4??
      0002E3 78 59            [12]  608 	mov	r0,#_KeyPress
      0002E5 E6               [12]  609 	mov	a,@r0
      0002E6 30 E3 05         [24]  610 	jnb	acc.3,00108$
                                    611 ;	src/main.c:99: Buf[i]=0x59;  //KEY4??????1??
      0002E9 75 0B 59         [24]  612 	mov	(_SendReport_Buf_65536_39 + 0x0002),#0x59
                                    613 ;	src/main.c:100: i++;  //????????
      0002EC 7F 03            [12]  614 	mov	r7,#0x03
      0002EE                        615 00108$:
                                    616 ;	src/main.c:102: if(KeyPress & KEY5)  //??KEY5??
      0002EE 78 59            [12]  617 	mov	r0,#_KeyPress
      0002F0 E6               [12]  618 	mov	a,@r0
      0002F1 30 E4 07         [24]  619 	jnb	acc.4,00110$
                                    620 ;	src/main.c:104: Buf[i]=0x5A;  //KEY5?????2??
      0002F4 EF               [12]  621 	mov	a,r7
      0002F5 24 09            [12]  622 	add	a,#_SendReport_Buf_65536_39
      0002F7 F8               [12]  623 	mov	r0,a
      0002F8 76 5A            [12]  624 	mov	@r0,#0x5a
                                    625 ;	src/main.c:105: i++;  //????????
      0002FA 0F               [12]  626 	inc	r7
      0002FB                        627 00110$:
                                    628 ;	src/main.c:107: if(KeyPress & KEY6)  //??KEY6??
      0002FB 78 59            [12]  629 	mov	r0,#_KeyPress
      0002FD E6               [12]  630 	mov	a,@r0
      0002FE 30 E5 07         [24]  631 	jnb	acc.5,00112$
                                    632 ;	src/main.c:109: Buf[i]=0x5B;  //KEY6??????3??
      000301 EF               [12]  633 	mov	a,r7
      000302 24 09            [12]  634 	add	a,#_SendReport_Buf_65536_39
      000304 F8               [12]  635 	mov	r0,a
      000305 76 5B            [12]  636 	mov	@r0,#0x5b
                                    637 ;	src/main.c:110: i++;  //????????
      000307 0F               [12]  638 	inc	r7
      000308                        639 00112$:
                                    640 ;	src/main.c:112: if(KeyPress & KEY7)  //??KEY7??
      000308 78 59            [12]  641 	mov	r0,#_KeyPress
      00030A E6               [12]  642 	mov	a,@r0
      00030B 30 E6 07         [24]  643 	jnb	acc.6,00114$
                                    644 ;	src/main.c:114: Buf[i]=0x39;  //KEY7??/??????
      00030E EF               [12]  645 	mov	a,r7
      00030F 24 09            [12]  646 	add	a,#_SendReport_Buf_65536_39
      000311 F8               [12]  647 	mov	r0,a
      000312 76 39            [12]  648 	mov	@r0,#0x39
                                    649 ;	src/main.c:115: i++;  //????????
      000314 0F               [12]  650 	inc	r7
      000315                        651 00114$:
                                    652 ;	src/main.c:117: if(KeyPress & KEY8)  //??KEY8??
      000315 78 59            [12]  653 	mov	r0,#_KeyPress
      000317 E6               [12]  654 	mov	a,@r0
      000318 30 E7 06         [24]  655 	jnb	acc.7,00116$
                                    656 ;	src/main.c:119: Buf[i]=0x53;  //KEY8????????????
      00031B EF               [12]  657 	mov	a,r7
      00031C 24 09            [12]  658 	add	a,#_SendReport_Buf_65536_39
      00031E F8               [12]  659 	mov	r0,a
      00031F 76 53            [12]  660 	mov	@r0,#0x53
      000321                        661 00116$:
                                    662 ;	src/main.c:122: D12_write_endpoint_buffer(3, 8, Buf);
      000321 75 18 09         [24]  663 	mov	_D12_write_endpoint_buffer_PARM_3,#_SendReport_Buf_65536_39
      000324 75 19 00         [24]  664 	mov	(_D12_write_endpoint_buffer_PARM_3 + 1),#0x00
      000327 75 1A 40         [24]  665 	mov	(_D12_write_endpoint_buffer_PARM_3 + 2),#0x40
      00032A 75 17 08         [24]  666 	mov	_D12_write_endpoint_buffer_PARM_2,#0x08
      00032D 75 82 03         [24]  667 	mov	dpl,#0x03
      000330 12 05 E0         [24]  668 	lcall	_D12_write_endpoint_buffer
                                    669 ;	src/main.c:123: Ep1InIsBusy=1;  //????????
      000333 75 43 01         [24]  670 	mov	_Ep1InIsBusy,#0x01
                                    671 ;	src/main.c:125: KeyUp=0;
      000336 78 5B            [12]  672 	mov	r0,#_KeyUp
      000338 76 00            [12]  673 	mov	@r0,#0x00
                                    674 ;	src/main.c:126: KeyDown=0;
      00033A 78 5A            [12]  675 	mov	r0,#_KeyDown
      00033C 76 00            [12]  676 	mov	@r0,#0x00
                                    677 ;	src/main.c:127: }
      00033E 22               [24]  678 	ret
                                    679 ;------------------------------------------------------------
                                    ...
                                    687 ;	-----------------------------------------
      00033F                        688 _ext0_ISR:
      00033F C0 20            [24]  689 	push	bits
      000341 C0 E0            [24]  690 	push	acc
      000343 C0 F0            [24]  691 	push	b
      000345 C0 82            [24]  692 	push	dpl
      000347 C0 83            [24]  693 	push	dph
      000349 C0 07            [24]  694 	push	(0+7)
      00034B C0 06            [24]  695 	push	(0+6)
      00034D C0 05            [24]  696 	push	(0+5)
      00034F C0 04            [24]  697 	push	(0+4)
      000351 C0 03            [24]  698 	push	(0+3)
      000353 C0 02            [24]  699 	push	(0+2)
      000355 C0 01            [24]  700 	push	(0+1)
      000357 C0 00            [24]  701 	push	(0+0)
      000359 C0 D0            [24]  702 	push	psw
      00035B 75 D0 00         [24]  703 	mov	psw,#0x00
                                    704 ;	src/main.c:133: D12_write_command(D12_READ_INTERRUPT_REG);
      00035E 75 82 F4         [24]  705 	mov	dpl,#0xf4
      000361 12 04 78         [24]  706 	lcall	_D12_write_command
                                    707 ;	src/main.c:134: status = D12_read_byte();
      000364 12 04 86         [24]  708 	lcall	_D12_read_byte
                                    709 ;	src/main.c:135: if(status & 0x80)
      000367 E5 82            [12]  710 	mov	a,dpl
      000369 FF               [12]  711 	mov	r7,a
      00036A 30 E7 07         [24]  712 	jnb	acc.7,00102$
                                    713 ;	src/main.c:136: usb_bus_isr_suspend();
      00036D C0 07            [24]  714 	push	ar7
      00036F 12 08 FD         [24]  715 	lcall	_usb_bus_isr_suspend
      000372 D0 07            [24]  716 	pop	ar7
      000374                        717 00102$:
                                    718 ;	src/main.c:137: if(status & 0x40)
      000374 EF               [12]  719 	mov	a,r7
      000375 30 E6 07         [24]  720 	jnb	acc.6,00104$
                                    721 ;	src/main.c:138: usb_bus_isr_reset();
      000378 C0 07            [24]  722 	push	ar7
      00037A 12 09 06         [24]  723 	lcall	_usb_bus_isr_reset
      00037D D0 07            [24]  724 	pop	ar7
      00037F                        725 00104$:
                                    726 ;	src/main.c:139: if(status & 0x01)
      00037F EF               [12]  727 	mov	a,r7
      000380 30 E0 07         [24]  728 	jnb	acc.0,00106$
                                    729 ;	src/main.c:140: usb_bus_isr_ep0_out();
      000383 C0 07            [24]  730 	push	ar7
      000385 12 09 13         [24]  731 	lcall	_usb_bus_isr_ep0_out
      000388 D0 07            [24]  732 	pop	ar7
      00038A                        733 00106$:
                                    734 ;	src/main.c:141: if(status & 0x02)
      00038A EF               [12]  735 	mov	a,r7
      00038B 30 E1 07         [24]  736 	jnb	acc.1,00108$
                                    737 ;	src/main.c:142: usb_bus_isr_ep0_in();
      00038E C0 07            [24]  738 	push	ar7
      000390 12 0D 8E         [24]  739 	lcall	_usb_bus_isr_ep0_in
      000393 D0 07            [24]  740 	pop	ar7
      000395                        741 00108$:
                                    742 ;	src/main.c:143: if(status & 0x04)
      000395 EF               [12]  743 	mov	a,r7
      000396 30 E2 07         [24]  744 	jnb	acc.2,00110$
                                    745 ;	src/main.c:144: usb_bus_isr_ep1_out();
      000399 C0 07            [24]  746 	push	ar7
      00039B 12 0D A0         [24]  747 	lcall	_usb_bus_isr_ep1_out
      00039E D0 07            [24]  748 	pop	ar7
      0003A0                        749 00110$:
                                    750 ;	src/main.c:145: if(status & 0x08)
      0003A0 EF               [12]  751 	mov	a,r7
      0003A1 30 E3 07         [24]  752 	jnb	acc.3,00112$
                                    753 ;	src/main.c:146: usb_bus_isr_ep1_in();
      0003A4 C0 07            [24]  754 	push	ar7
      0003A6 12 0D CA         [24]  755 	lcall	_usb_bus_isr_ep1_in
      0003A9 D0 07            [24]  756 	pop	ar7
      0003AB                        757 00112$:
                                    758 ;	src/main.c:147: if(status & 0x10)
      0003AB EF               [12]  759 	mov	a,r7
      0003AC 30 E4 07         [24]  760 	jnb	acc.4,00114$
                                    761 ;	src/main.c:148: usb_bus_isr_ep2_out();
      0003AF C0 07            [24]  762 	push	ar7
      0003B1 12 0D DD         [24]  763 	lcall	_usb_bus_isr_ep2_out
      0003B4 D0 07            [24]  764 	pop	ar7
      0003B6                        765 00114$:
                                    766 ;	src/main.c:149: if(status & 0x20)
      0003B6 EF               [12]  767 	mov	a,r7
      0003B7 30 E5 03         [24]  768 	jnb	acc.5,00117$
                                    769 ;	src/main.c:150: usb_bus_isr_ep2_in();
      0003BA 12 0D E6         [24]  770 	lcall	_usb_bus_isr_ep2_in
      0003BD                        771 00117$:
                                    772 ;	src/main.c:151: }
      0003BD D0 D0            [24]  773 	pop	psw
      0003BF D0 00            [24]  774 	pop	(0+0)
      0003C1 D0 01            [24]  775 	pop	(0+1)
      0003C3 D0 02            [24]  776 	pop	(0+2)
      0003C5 D0 03            [24]  777 	pop	(0+3)
      0003C7 D0 04            [24]  778 	pop	(0+4)
      0003C9 D0 05            [24]  779 	pop	(0+5)
      0003CB D0 06            [24]  780 	pop	(0+6)
      0003CD D0 07            [24]  781 	pop	(0+7)
      0003CF D0 83            [24]  782 	pop	dph
      0003D1 D0 82            [24]  783 	pop	dpl
      0003D3 D0 F0            [24]  784 	pop	b
      0003D5 D0 E0            [24]  785 	pop	acc
      0003D7 D0 20            [24]  786 	pop	bits
      0003D9 32               [24]  787 	reti
                                    788 ;------------------------------------------------------------
                                    ...
                                    796 ;	-----------------------------------------
      0003DA                        797 _timer0_ISR:
      0003DA C0 E0            [24]  798 	push	acc
      0003DC C0 F0            [24]  799 	push	b
      0003DE C0 07            [24]  800 	push	ar7
      0003E0 C0 01            [24]  801 	push	ar1
      0003E2 C0 00            [24]  802 	push	ar0
      0003E4 C0 D0            [24]  803 	push	psw
      0003E6 75 D0 00         [24]  804 	mov	psw,#0x00
                                    805 ;	src/main.c:157: TH0 = (65536 - TIMER0_RELOAD_NUM) / 256;
      0003E9 75 8C DC         [24]  806 	mov	_TH0,#0xdc
                                    807 ;	src/main.c:158: TL0 = (65536 - TIMER0_RELOAD_NUM) % 256;
      0003EC 75 8A 00         [24]  808 	mov	_TL0,#0x00
                                    809 ;	src/main.c:160: i++;
      0003EF 05 11            [12]  810 	inc	_timer0_ISR_i_65536_51
      0003F1 E4               [12]  811 	clr	a
      0003F2 B5 11 02         [24]  812 	cjne	a,_timer0_ISR_i_65536_51,00128$
      0003F5 05 12            [12]  813 	inc	(_timer0_ISR_i_65536_51 + 1)
      0003F7                        814 00128$:
                                    815 ;	src/main.c:161: if (i > 200) {
      0003F7 C3               [12]  816 	clr	c
      0003F8 74 C8            [12]  817 	mov	a,#0xc8
      0003FA 95 11            [12]  818 	subb	a,_timer0_ISR_i_65536_51
      0003FC E4               [12]  819 	clr	a
      0003FD 95 12            [12]  820 	subb	a,(_timer0_ISR_i_65536_51 + 1)
      0003FF 50 05            [24]  821 	jnc	00102$
                                    822 ;	src/main.c:162: i = 0;
      000401 E4               [12]  823 	clr	a
      000402 F5 11            [12]  824 	mov	_timer0_ISR_i_65536_51,a
      000404 F5 12            [12]  825 	mov	(_timer0_ISR_i_65536_51 + 1),a
      000406                        826 00102$:
                                    827 ;	src/main.c:166: if (!KeyCanChange)
      000406 78 5D            [12]  828 	mov	r0,#_KeyCanChange
      000408 E6               [12]  829 	mov	a,@r0
      000409 70 02            [24]  830 	jnz	00104$
                                    831 ;	src/main.c:167: return;
      00040B 80 55            [24]  832 	sjmp	00110$
      00040D                        833 00104$:
                                    834 ;	src/main.c:169: KeyCurrent = GetKeyValue();
      00040D E5 90            [12]  835 	mov	a,_P1
      00040F F4               [12]  836 	cpl	a
      000410 FF               [12]  837 	mov	r7,a
      000411 78 56            [12]  838 	mov	r0,#_KeyCurrent
      000413 A6 07            [24]  839 	mov	@r0,ar7
                                    840 ;	src/main.c:171: if (KeyCurrent != KeyOld) {
      000415 78 56            [12]  841 	mov	r0,#_KeyCurrent
      000417 79 57            [12]  842 	mov	r1,#_KeyOld
      000419 86 F0            [24]  843 	mov	b,@r0
      00041B E7               [12]  844 	mov	a,@r1
      00041C B5 F0 02         [24]  845 	cjne	a,b,00131$
      00041F 80 0C            [24]  846 	sjmp	00108$
      000421                        847 00131$:
                                    848 ;	src/main.c:172: KeyNoChangedTime = 0;
      000421 78 58            [12]  849 	mov	r0,#_KeyNoChangedTime
      000423 76 00            [12]  850 	mov	@r0,#0x00
                                    851 ;	src/main.c:173: KeyOld = KeyCurrent;
      000425 78 56            [12]  852 	mov	r0,#_KeyCurrent
      000427 79 57            [12]  853 	mov	r1,#_KeyOld
      000429 E6               [12]  854 	mov	a,@r0
      00042A F7               [12]  855 	mov	@r1,a
                                    856 ;	src/main.c:174: return;
      00042B 80 35            [24]  857 	sjmp	00110$
      00042D                        858 00108$:
                                    859 ;	src/main.c:177: KeyNoChangedTime++;
      00042D 78 58            [12]  860 	mov	r0,#_KeyNoChangedTime
      00042F E6               [12]  861 	mov	a,@r0
      000430 78 58            [12]  862 	mov	r0,#_KeyNoChangedTime
      000432 04               [12]  863 	inc	a
      000433 F6               [12]  864 	mov	@r0,a
                                    865 ;	src/main.c:178: if (KeyNoChangedTime >= 1) {
      000434 78 58            [12]  866 	mov	r0,#_KeyNoChangedTime
      000436 B6 01 00         [24]  867 	cjne	@r0,#0x01,00132$
      000439                        868 00132$:
      000439 40 27            [24]  869 	jc	00110$
                                    870 ;	src/main.c:179: KeyNoChangedTime = 1;
      00043B 78 58            [12]  871 	mov	r0,#_KeyNoChangedTime
      00043D 76 01            [12]  872 	mov	@r0,#0x01
                                    873 ;	src/main.c:180: KeyPress = KeyOld;
      00043F 78 57            [12]  874 	mov	r0,#_KeyOld
      000441 79 59            [12]  875 	mov	r1,#_KeyPress
      000443 E6               [12]  876 	mov	a,@r0
      000444 F7               [12]  877 	mov	@r1,a
                                    878 ;	src/main.c:181: KeyDown |= (~KeyLast) & (KeyPress);
      000445 78 5C            [12]  879 	mov	r0,#_KeyLast
      000447 E6               [12]  880 	mov	a,@r0
      000448 F4               [12]  881 	cpl	a
      000449 FF               [12]  882 	mov	r7,a
      00044A 78 59            [12]  883 	mov	r0,#_KeyPress
      00044C E6               [12]  884 	mov	a,@r0
      00044D 5F               [12]  885 	anl	a,r7
      00044E 78 5A            [12]  886 	mov	r0,#_KeyDown
      000450 46               [12]  887 	orl	a,@r0
      000451 F6               [12]  888 	mov	@r0,a
                                    889 ;	src/main.c:182: KeyUp |= KeyLast & (KeyPress);
      000452 78 5C            [12]  890 	mov	r0,#_KeyLast
      000454 79 59            [12]  891 	mov	r1,#_KeyPress
      000456 E7               [12]  892 	mov	a,@r1
      000457 56               [12]  893 	anl	a,@r0
      000458 78 5B            [12]  894 	mov	r0,#_KeyUp
      00045A 46               [12]  895 	orl	a,@r0
      00045B F6               [12]  896 	mov	@r0,a
                                    897 ;	src/main.c:183: KeyLast = KeyPress;
      00045C 78 59            [12]  898 	mov	r0,#_KeyPress
      00045E 79 5C            [12]  899 	mov	r1,#_KeyLast
      000460 E6               [12]  900 	mov	a,@r0
      000461 F7               [12]  901 	mov	@r1,a
      000462                        902 00110$:
                                    903 ;	src/main.c:186: }
      000462 D0 D0            [24]  904 	pop	psw
      000464 D0 00            [24]  905 	pop	ar0
      000466 D0 01            [24]  906 	pop	ar1
      000468 D0 07            [24]  907 	pop	ar7
      00046A D0 F0            [24]  908 	pop	b
      00046C D0 E0            [24]  909 	pop	acc
      00046E 32               [24]  910 	reti
                                    ...
                                    919 ;	-----------------------------------------
      00046F                        920 _uart_ISR:
                                    921 ;	src/main.c:190: if (RI) {
                                    922 ;	src/main.c:191: RI = 0;			/* clear recieve interrupt */
                                    923 ;	assignBit
      00046F 10 98 05         [24]  924 	jbc	_RI,00104$
                                    925 ;	src/main.c:193: TI = 0;
                                    926 ;	assignBit
      000472 C2 99            [12]  927 	clr	_TI
                                    928 ;	src/main.c:194: sending = 0;
      000474 75 21 00         [24]  929 	mov	_sending,#0x00
      000477                        930 00104$:
                                    931 ;	src/main.c:196: }
      000477 32               [24]  932 	reti
                                    ...
                                    941 	.area CONST   (CODE)
      000FAC                        942 ___str_0:
      000FAC 72 65 61 64 20 70 64   943 	.ascii "read pdiusb12 id is: "
             69 75 73 62 31 32 20
             69 64 20 69 73 3A 20
      000FC1 00                     944 	.db 0x00
                                    945 	.area CSEG    (CODE)
                                    946 	.area CONST   (CODE)
      000FC2                        947 ___str_1:
      000FC2 0A                     948 	.db 0x0a
      000FC3 00                     949 	.db 0x00
                                    950 	.area CSEG    (CODE)
                                    951 	.area XINIT   (CODE)
