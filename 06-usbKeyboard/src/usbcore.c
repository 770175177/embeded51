...
__code uint8 ConfigurationDescriptor[9 + 9 + 9 + 7 + 7] = {      /* desciptor length is 34 bytes */
    ...
    0x02,   /* bNumEndpoints, number of endpoints number except 0 endpoint, key has 2 interrupt endpoint */
    0x03,   /* bInterfaceClass, key is HID class, HID class is 0x03 */
    0x01,   /* bInterfaceSubClass, HID1.1 has only one sub class support BOIS, key and keyboard belongs to it */
    0x01,   /* bInterfaceProtocol, if sub class support loader, mouse = 0x2, keyboard=0x1 */
    0x00,   /* iConfiguration, has no string */
    ...
    0x81,   /* bEndpointAddress, input endpoint D7 is 1, D7 indicate data transfer direction, 1 = IN */
    ...
    0x07,   /* bLength */
    0x05,   /* bDescriptorType, endpoint descriptor type */
    0x01,   /* bEndpointAddress, output endpoint D7 is 1, D7 indicate data transfer direction, 1 = IN */
    0x03,   /* bmAttribute, D1~D0 is transfer type */
    0x10,   /* wMaxPacketSize, the endpoint max packet length is 16 bytes, low is the first */
    0x00,
    0x0A    /* bInterval, the endpoint query time, 10 frame is 10 ms */
...
__code uint8 ReportDescriptor[] = {
    ...
    0x05, 0x01,
    /* item2: local item(bType is 2), this usage is keyboard(0x06) */
    0x09, 0x06,
    ...
    0x19, 0xE0,
    /* item6: local item, usage max is 0xE7, infact is keyboard right Win button */ 
    0x29, 0xE7,
    /* item7: global item, logical number of returned data, min is 0 */
    0x15, 0x00,
    /* item8: global item, logical number of returned data, max is 1 */
    0x25, 0x01,
    /* item9: global item, indicate data length is 8 */
    0x95, 0x08,
    /* item10: global item, each datda length is 1 */
    0x75, 0x01,
    /* item11: main item, has 8 data of length 1(definded proved), as input: Data, Var, Abs */
    /* when one data is 1, indicate this key has typed, bit 0 indicate min usage 0xE0, bit 7 indicate max usage 0xE7 */
    0x81, 0x02,
    /* item12: global item, data num is 1 */
    0x95, 0x01,
    /* item13: global item, each data length is 8 */
    0x75, 0x08,
    /* item14: main item, for input */
    0x81, 0x03,
    /* item15: global item, data bit number is 6 */
    0x95, 0x06,
    /* item17: global item, each data bit length is 8 bit */
    0x75, 0x08,
    /* item18: global item, logical min number is 0 */
    0x15, 0x00,
    /* item19: global item, logical max number is 255 */
    0x25, 0xFF,
    /* item20: global item, usage is keyboard */
    0x05, 0x07,
    /* item21: global item, usage min is 0 */
    0x19, 0x00,
    /* item22: global item, usage max is 0x65 */
    0x29, 0x65,
    /* item23: main item, input: Data, Ary, Abs */
    0x81, 0x00,

    /* the fallowing is output */
    /* item24: global item, logical max is 1 */
    0x25, 0x01,
    /* item25: global item, data bit number is 5 */
    0x95, 0x05,
    /* item26: global item, data bit length is 1 bit */
    0x75, 0x01,
    /* item27: global item, usage is indicator light */
    0x05, 0x08,
    /* item28: local item, usage min is num light */
    0x19, 0x01,
    /* item29: local item, usage max is Kana light */
    0x29, 0x05,
    /* item30: main item, output data, there are 5 light */
    0x91, 0x02,
    /* item31: global item, data bit num is 1 */
    0x95, 0x01,
    /* item32: global item, data bit length is 3 bit */
    0x75, 0x03,
