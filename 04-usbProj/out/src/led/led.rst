      ...
      000013                        275 _led_light_on_PARM_2:
      000013                        276 	.ds 1
      ...
      000180                        343 _led_light_on:
                           ...
                           000001   350 	ar1 = 0x01
                           000000   351 	ar0 = 0x00
      000180 AF 82            [24]  352 	mov	r7,dpl
                                    353 ;	src/led.c:5: if (index >= LED_NUM)
      000182 BF 08 00         [24]  354 	cjne	r7,#0x08,00116$
      000185                        355 00116$:
      000185 40 04            [24]  356 	jc	00102$
                                    357 ;	src/led.c:6: return -1;
      000187 90 FF FF         [24]  358 	mov	dptr,#0xffff
      00018A 22               [24]  359 	ret
      00018B                        360 00102$:
                                    361 ;	src/led.c:8: if (on)
      00018B E5 13            [12]  362 	mov	a,_led_light_on_PARM_2
      00018D 60 15            [24]  363 	jz	00104$
                                    364 ;	src/led.c:9: LED &= ~(0x1 << index);
      00018F 8F 06            [24]  365 	mov	ar6,r7
      000191 8E F0            [24]  366 	mov	b,r6
      000193 05 F0            [12]  367 	inc	b
      000195 74 01            [12]  368 	mov	a,#0x01
      000197 80 02            [24]  369 	sjmp	00121$
      000199                        370 00119$:
      000199 25 E0            [12]  371 	add	a,acc
      00019B                        372 00121$:
      00019B D5 F0 FB         [24]  373 	djnz	b,00119$
      00019E F4               [12]  374 	cpl	a
      00019F FE               [12]  375 	mov	r6,a
      0001A0 52 A0            [12]  376 	anl	_P2,a
      0001A2 80 10            [24]  377 	sjmp	00105$
      0001A4                        378 00104$:
                                    379 ;	src/led.c:11: LED |= (0x1 << index);
      0001A4 8F F0            [24]  380 	mov	b,r7
      0001A6 05 F0            [12]  381 	inc	b
      0001A8 74 01            [12]  382 	mov	a,#0x01
      0001AA 80 02            [24]  383 	sjmp	00124$
      0001AC                        384 00122$:
      0001AC 25 E0            [12]  385 	add	a,acc
      0001AE                        386 00124$:
      0001AE D5 F0 FB         [24]  387 	djnz	b,00122$
      0001B1 FF               [12]  388 	mov	r7,a
      0001B2 42 A0            [12]  389 	orl	_P2,a
      0001B4                        390 00105$:
                                    391 ;	src/led.c:13: return 0;
      0001B4 90 00 00         [24]  392 	mov	dptr,#0x0000
                                    393 ;	src/led.c:14: }
      0001B7 22               [24]  394 	ret
                                    395 ;------------------------------------------------------------
                                    ...
                                    404 ;	-----------------------------------------
      0001B8                        405 _led_light_is_on:
      0001B8 AF 82            [24]  406 	mov	r7,dpl
                                    407 ;	src/led.c:20: if (index >= LED_NUM)
      0001BA BF 08 00         [24]  408 	cjne	r7,#0x08,00116$
      0001BD                        409 00116$:
      0001BD 40 04            [24]  410 	jc	00102$
                                    411 ;	src/led.c:21: return false;
      0001BF 75 82 00         [24]  412 	mov	dpl,#0x00
      0001C2 22               [24]  413 	ret
      0001C3                        414 00102$:
                                    415 ;	src/led.c:23: value = LED;
      0001C3 E5 A0            [12]  416 	mov	a,_P2
                                    417 ;	src/led.c:25: if ((value >> index) & 0x1)
      0001C5 8F F0            [24]  418 	mov	b,r7
      0001C7 05 F0            [12]  419 	inc	b
      0001C9 80 02            [24]  420 	sjmp	00119$
      0001CB                        421 00118$:
      0001CB C3               [12]  422 	clr	c
      0001CC 13               [12]  423 	rrc	a
      0001CD                        424 00119$:
      0001CD D5 F0 FB         [24]  425 	djnz	b,00118$
      0001D0 30 E0 04         [24]  426 	jnb	acc.0,00104$
                                    427 ;	src/led.c:26: return false;
      0001D3 75 82 00         [24]  428 	mov	dpl,#0x00
      0001D6 22               [24]  429 	ret
      0001D7                        430 00104$:
                                    431 ;	src/led.c:28: return true;
      0001D7 75 82 01         [24]  432 	mov	dpl,#0x01
                                    433 ;	src/led.c:29: }
      0001DA 22               [24]  434 	ret
                                    435 	.area CSEG    (CODE)
                                    436 	.area CONST   (CODE)
                                    437 	.area XINIT   (CODE)
